...
export const TIME_RESERVED_ERROR_MESSAGE: string =
  'ساعت انتخاب شده قبلا رزرو شده است';
export const TARGETUSER_AND_USERTYPE_NOT_FIELD_ERROR_MESSAGE: string =
  'کاربر یا گروه کاربران را وارد کنید';

export const PAYED_ERROR_MESSAGE: string = 'این نوبت قبلا پرداخت شده است';
export const BANK_INFO_ERROR_MESSAGE: string =
  'لطفا اطلاعات مربوط به حساب بانکی را وارد کنید';

export const IS_EXIT_ERROR_MESSAGE: string = 'شما باید مجدد وارد شوید';

export const USER_NOT_COMPLETED: string = 'نیاز هست حساب خود را تکمیل کنید';

export const RECORD_NOT_FOUND_ERROR_MESSAGE: string = 'یافت نشد';
export const USER_NOT_COMLETED_Exception_ERROR_MESSAGE: string =
  'حساب کاربر تکمیل نشده';
export const YOU_HAVE_ANOTHER_TURN_ERROR_MESSAGE: string =
  'شما یک نوبت از قبل دارید';
...
export const CHAT_TURN_PRICE_ERROR_MESSAGE: string =
  'لطفا هزینه نوبت دهی متنی را بنویسید';
...
export const MEDICAL_SYSTEM_CODE_IS_DUPLICATE_ERROR_MESSAGE: string =
  'کد نظام پزشکی تکراری میباشد';
...
export const TELL_TURN_SETTING_ERROR_MESSAGE: string =
  'لطفا اطلاعات مشاوره تلفنی را وارد کنید';
